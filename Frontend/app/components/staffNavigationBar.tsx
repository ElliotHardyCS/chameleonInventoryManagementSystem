  ...
  return (
    <nav className = "flex flex-col w-auto bg-[#111111]">
      <div className = "flex flex-row px-2 py-2 justify-between">
        ...
        <div className = "flex flex-row space-x-2">
          <button onClick={() => router.push('/staffLandingPage')} className = "text-white text-2xl px-4 py-2 rounded hover:underline"> Home </button>
          <button onClick={() => router.push('/')} className = "text-white text-2xl px-4 py-2 rounded hover:underline"> Sign out </button>
        </div>
      </div>
