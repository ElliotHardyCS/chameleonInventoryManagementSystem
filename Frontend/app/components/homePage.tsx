export default function HomePage() {
  return (
    <main className = "flex flex-col bg-[#262626] min-h-screen px-20 py-5 space-y-5">
      <img src = "/CHAMELEON_LOGO_COLOUR.svg" height={100} width={300} />
      <div className = "flex flex-col space-y-5 items-center text-section text-white">
        <p>
      ...
      <div className = "items-center space-y-10" id = "Service links">
